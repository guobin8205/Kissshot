...
inline Matrix4x4 MtxOrtho(float _left, float _right, float _bottom, float _top, float _near, float _far, float _offset = 0.0f, bool _center = false)
{
	Matrix4x4 res;
...
inline Matrix4x4 MtxOrtho(float _width, float _height, float _near, float _far, float _offset = 0.0f, bool _center = false)
{
	Matrix4x4 res;
